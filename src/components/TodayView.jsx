...
function WatercolorPerson({ sitting = false, bouncing = false }) {
  return (
    ...
    >
      {/* Hair */}
      <path d="M 15 8 Q 13 2 20 1 Q 26 0 32 2 Q 38 4 37 10 Q 38 6 36 4 Q 28 -1 20 1 Q 13 3 15 8 Z" fill="#5C3D1E" opacity="0.95" />
      ...
      <path d="M 18 6 Q 20 8 23 7 Q 26 6 28 8 Q 26 5 22 5 Q 19 5 18 6 Z" fill="#7A5030" opacity="0.6" />
      ...
      {/* Eyelashes */}
      <path d="M 20 13 Q 19 11 19.5 10.5" stroke="#4A3020" strokeWidth="0.8" strokeLinecap="round" fill="none" />
      <path d="M 22 12.5 Q 21.5 10.5 22 10" stroke="#4A3020" strokeWidth="0.8" strokeLinecap="round" fill="none" />
      <path d="M 28 12.5 Q 28.5 10.5 28 10" stroke="#4A3020" strokeWidth="0.8" strokeLinecap="round" fill="none" />
      <path d="M 30 13 Q 31 11 30.5 10.5" stroke="#4A3020" strokeWidth="0.8" strokeLinecap="round" fill="none" />
      ...
      {/* Mouth */}
      {!sitting && (
        <path d="M 22 23 Q 26 26 30 23" stroke="#D07060" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      )}
      {sitting && (
        <path d="M 23 23 Q 26 25 29 23" stroke="#D07060" strokeWidth="1.4" fill="none" strokeLinecap="round" />
      )}

      {/* Body — sage green shirt */}
      {!sitting && (
        <>
          <path d="M 16 28 Q 14 32 15 42 L 37 42 Q 38 32 36 28 Q 30 26 22 26 Z" fill="#7BAE8C" />
          <path d="M 22 26 Q 26 30 30 26" stroke="#5C9070" strokeWidth="1.5" fill="none" strokeLinecap="round" />
          <path d="M 16 29 Q 10 32 9 40 Q 12 41 14 40 Q 14 34 17 31 Z" fill="#7BAE8C" />
          <path d="M 36 29 Q 42 32 43 40 Q 40 41 38 40 Q 38 34 35 31 Z" fill="#7BAE8C" />
          <ellipse cx="11" cy="41" rx="3.5" ry="3" fill="#FDDCB8" />
          <ellipse cx="41" cy="41" rx="3.5" ry="3" fill="#FDDCB8" />
          <path d="M 15 42 L 14 60 L 23 60 L 26 50 L 29 60 L 38 60 L 37 42 Z" fill="#9090B8" />
      ...
      {sitting && (
        <>
          <path d="M 16 28 Q 14 32 15 40 L 37 40 Q 38 32 36 28 Q 30 26 22 26 Z" fill="#7BAE8C" />
          <path d="M 22 26 Q 26 30 30 26" stroke="#5C9070" strokeWidth="1.5" fill="none" strokeLinecap="round" />
          <path d="M 16 30 Q 10 36 12 44 Q 15 45 16 44 Q 15 37 18 33 Z" fill="#7BAE8C" />
          <path d="M 36 30 Q 42 36 40 44 Q 37 45 36 44 Q 37 37 34 33 Z" fill="#7BAE8C" />
...
function WateringCan({ tipped = false }) {
  return (
    ...
    >
      ...
      {/* Spout */}
      <path d="M 26 18 Q 34 16 38 14 Q 38 18 36 20 Q 32 20 26 22 Z" fill="#B8A8C8" />
      <ellipse cx="38" cy="16" rx="2.5" ry="3" fill="#B8A8C8" />

      {/* Handle */}
      <path d="M 5 12 Q 2 8 4 4 Q 7 2 10 4 Q 8 8 8 12" stroke="#B8A8C8" strokeWidth="3" fill="none" strokeLinecap="round" />
...
// ─────────────────────────────────────────────────────────────
// WIN SLOT — one of the 3 possible daily slots
// ─────────────────────────────────────────────────────────────
      ...
      <div style={{ display: 'flex', gap: '8px', alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1, position: 'relative' }}>
          <textarea
            ...
            placeholder={
              slotNumber === 1
                ? 'what is one small thing you did today?'
                : slotNumber === 2
                ? 'anything else worth celebrating?'
                : 'one more gentle win...'
            }
            rows={2}
            autoFocus={isActive}
...
export default function TodayView({ momMode }) {
  ...
  function handleWinSubmit(text) {
    const allWins = getAllWinsSorted()
    const flowerIdx = allWins.length
